...
function useMenu(props = {}) {
  ...
  const focusMenu = (0, import_react14.useCallback)(() => {
    requestAnimationFrame(() => {
      var _a;
      (_a = menuRef.current) == null ? void 0 : _a.focus({ preventScroll: false });
    });
  }, []);
  const focusFirstItem = (0, import_react14.useCallback)(() => {
  ...
  const focusLastItem = (0, import_react14.useCallback)(() => {
    const id2 = setTimeout(() => {
  ...
  const onOpenInternal = (0, import_react14.useCallback)(() => {
  ...
  const openAndFocusMenu = (0, import_react14.useCallback)(() => {
    onOpen();
    focusMenu();
  }, [onOpen, focusMenu]);
  const timeoutIds = (0, import_react14.useRef)(/* @__PURE__ */ new Set([]));
  useUnmountEffect(() => {
    timeoutIds.current.forEach((id2) => clearTimeout(id2));
    timeoutIds.current.clear();
  });
  const openAndFocusFirstItem = (0, import_react14.useCallback)(() => {
    onOpen();
    focusFirstItem();
  }, [focusFirstItem, onOpen]);
  const openAndFocusLastItem = (0, import_react14.useCallback)(() => {
    onOpen();
    focusLastItem();
  }, [onOpen, focusLastItem]);
  const refocus = (0, import_react14.useCallback)(() => {
    var _a, _b;
  ...
  const rafId = (0, import_react14.useRef)(null);
  return {
    openAndFocusMenu,
...
function useMenuList(props = {}, ref = null) {
  ...
  const hasBeenOpened = (0, import_react14.useRef)(false);
  if (isOpen) {
...
function useMenuItem(props = {}, externalRef = null) {
  ...
  const id = `${menuId}-menuitem-${(0, import_react14.useId)()}`;
  ...
  const onMouseMove = (0, import_react14.useCallback)(
    (event) => {
...
var Menu = (props) => {
  ...
  const context = (0, import_react15.useMemo)(() => ctx, [ctx]);
...
var StyledMenuItem = forwardRef(
  (props, ref) => {
    ...
    const buttonStyles = (0, import_react16.useMemo)(
      () => ({
        textDecoration: "none",
        color: "inherit",
        userSelect: "none",
...
var MenuIcon = (props) => {
  ...
  const styles = useMenuStyles();
  const child = import_react17.Children.only(children);
  const clone = (0, import_react17.isValidElement)(child) ? (0, import_react17.cloneElement)(child, {
    focusable: "false",
    "aria-hidden": true,
...
//# sourceMappingURL=chunk-JGSE4XEA.js.map
