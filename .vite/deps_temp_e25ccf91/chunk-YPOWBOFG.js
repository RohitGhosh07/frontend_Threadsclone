...
function useUpdateEffect(callback, deps) {
  const renderCycleRef = (0, import_react2.useRef)(false);
  const effectCycleRef = (0, import_react2.useRef)(false);
...
function usePresence() {
  ...
  (0, import_react4.useEffect)(() => register(id3), []);
...
function MeasureLayout(props) {
  ...
  return import_react20.default.createElement(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react20.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove });
}
...
function ReorderItem({ children, style = {}, value, as = "li", onDrag, layout: layout2 = true, ...props }, externalRef) {
  ...
  const measuredLayout = (0, import_react34.useRef)(null);
...
//# sourceMappingURL=chunk-YPOWBOFG.js.map
