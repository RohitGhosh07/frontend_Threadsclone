...
var ToastProvider = (props) => {
  ...
  const toastList = stateKeys.map((position) => {
    ...
    return (0, import_jsx_runtime10.jsx)(
      "div",
      {
        ...
        children: (0, import_jsx_runtime10.jsx)(AnimatePresence, { initial: false, children: toasts.map((toast) => (0, import_jsx_runtime10.jsx)(
          Component,
          {
            motionVariants,
            ...toast
  ...
  return (0, import_jsx_runtime10.jsx)(Portal, { ...portalProps, children: toastList });
};
...
function createStandaloneToast({
  ...
  const ToastContainer = () => (0, import_jsx_runtime11.jsx)(ThemeProvider, { theme, children: (0, import_jsx_runtime11.jsx)(ColorModeContext.Provider, { value: colorModeContextValue, children: (0, import_jsx_runtime11.jsx)(
    ToastProvider,
    {
      defaultOptions,
      motionVariants,
...
//# sourceMappingURL=chunk-FW3V5QYR.js.map
